...
const myModule = (()=>{
    ...
    btnAreaSquare.addEventListener('click', ()=>{
        ...
        const result = `El área de Cuadrado es: ${areaSquare(value)} cm2`;
        valueResult.innerText = result;
    });
    /**
    ...
    */
    ...
    btnAreaTriangle.addEventListener('click', ()=>{
        ...
        const result = `El área de Triangulo es: ${areaTriangle(base, height)} cm2`;
        valueResult.innerText=result;
    });
    ...
    */
    ...
    btnAreaCircle.addEventListener('click',()=>{
        ...
        const result = `El área de Circulo es: ${areaCircle(radio)} cm2`;
        valueResult.innerText=result;
    });
